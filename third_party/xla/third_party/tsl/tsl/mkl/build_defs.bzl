...
def mkl_deps():
    ...
    return select({
        ...
        "@local_tsl//tsl:linux_x86_64_with_onednn_v2": ["@mkl_dnn_v1//:mkl_dnn"],
        "@local_tsl//tsl:linux_x86_64_with_onednn_v3": ["@onednn_v3//:mkl_dnn"],
        "@local_tsl//tsl:windows": ["@mkl_dnn_v1//:mkl_dnn"],
        "//conditions:default": [],
    })
